...
urlpatterns = [
    ...
    path('search/home/', views.SearchPatientsProfileView.as_view(), name='SearchPatientsHome'),
    path('search_user/', views.SearchUserView.as_view(), name='SearchUsers'),
    path('patient/list/<slug:slug>', views.patients_list_view, name='viewpatients'),
    ...
    path('patient/assign/<patient_id>/<str:user_id>', views.assigndoctor,name='assigndoctor'),
    ...
    path('report/<str:pk>/', views.view_report, name='viewreport'),
